...
#define LEVEL_FLASH             100
#define LEVEL_STEADY            45
...
void loop()
{
  ...
  case MODE_BLINKING_PREVIEW:
    ...
    break;
  case MODE_BIKE:
    analogWrite(DPIN_DRV_EN, (time%500)<75 ? LEVEL_FLASH : LEVEL_STEADY);
  }
  ...
  if (newMode != mode)
  {
    ...
    case MODE_BLINKING_PREVIEW:
      ...
      break;
    case MODE_BIKE:
      Serial.println("Mode = bike");
      pinMode(DPIN_PWR, OUTPUT);
      digitalWrite(DPIN_PWR, HIGH);
      digitalWrite(DPIN_DRV_MODE, HIGH);
      analogWrite(DPIN_DRV_EN, 45);
    }
